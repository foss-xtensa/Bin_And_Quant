...
tflite_model='/home/ms75986/Desktop/Cadence/bin_quant/Bin_And_Quant/slim/mobilenet_models/v3-large_224_1.0_uint8/v3-large_224_1.0_uint8.tflite'

#tflite_model='/home/ms75986/Desktop/Cadence/bin_quant/Bin_And_Quant/slim/mobilenet_top_acc_model_0_.tflite'
model_name='mobilenet_v3' #'inception_v1'
eval_size='1000'
...
modified_file = 'v3_mobilenet_modified.tflite'
top_model_file = 'v3_mobilenet_top_acc_model.tflite'
num_layers = 1 #starts with zero
...
#top_model_file = 'v1_mobilenet_top_acc_model_'+str(curr_layer)+'_.tflite'
...
for curr_layer in range(num_layers): ########## change range from 0,num_layers
    ...
    if curr_layer >0: ##modified for mobilenet_v1 as >1
        max_bins = 16
    ...
    top_acc = curr_acc
    model = load_model_from_file(tflite_model)
    top_model_file = 'v3_mobilenet_top_acc_model_'+str(curr_layer)+'_.tflite'
