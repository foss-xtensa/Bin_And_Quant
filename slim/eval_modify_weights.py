...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
      saver = tf.train.import_meta_graph('/home/ms75986/Desktop/Cadence/bin_quant/MobileNet/models/research/slim/v2_224_100/model.ckpt-2685865.meta')
      saver.restore(sess,  '/home/ms75986/Desktop/Cadence/bin_quant/MobileNet/models/research/slim/v2_224_100/model.ckpt-2685865')
      #saver.restore(sess,  '/home/ms75986/Desktop/Cadence/bin_quant/MobileNet/models/research/slim/mobilenet_v1_1.0_224_quant.ckpt')
      ...
      RangeValues = [np.min(v2),-0.01,0.0]
      ...
      #sess.run(tf.assign(v1,v2_r))

      saver.save(sess, '/home/ms75986/Desktop/Cadence/bin_quant/MobileNet/models/research/slim/v2_224_100/model.ckpt-2685865-modified',write_meta_graph=True)
      #saver.save(sess, '/home/ms75986/Desktop/Cadence/bin_quant/MobileNet/models/research/slim/mobilenet_v1_1.0_224_quant-modified.ckpt',write_meta_graph=True)
