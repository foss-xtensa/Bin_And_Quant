...
#change#
#tflite_model='inception_top_acc_model_1_.tflite'
...
modified_file = 'inception_modified.tflite'
top_model_file = 'inception_top_acc_model.tflite'
num_layers = 5 #starts with zero
...
for curr_layer in range(num_layers): ########## change range from 0,num_layers
    ...
    #modification to process only layer 3 ***********************
